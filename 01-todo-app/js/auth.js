// ---- Simple client-side auth using localStorage (demo purposes only) ----
const DB_USERS = 'todo_users';
const DB_SESSION = 'todo_session';
...
function handleRegister(e) {
  ...
  saveUsers(users);
  msg.innerHTML = '<div class="alert alert-success">Account created! Redirecting to login...</div>';
